            ...
            <SafeAreaView style={[styles.container, safeArea.AndroidSafeArea]}>
                ...
                >
                    <Image
                        ...
                        resizeMode="cover"
                        style={{
                            width: Screen.width / 3, // Reduced the size of the profile picture
                            height: Screen.width / 3, // Reduced the size of the profile picture
                            borderRadius: 100,
                            marginBottom: 25,
                        }}
                    />
                    ...
                    <Text style={{ color: "#3a3a3a", fontWeight: "500", fontSize: 16 }}>
                        {email}
                    </Text>
                    <TouchableOpacity
                        style={{
