  ...
  return (
    <TouchableOpacity
      onPress={() => {
        ...
        setUnreadMessages(0);
        setIsFetchingUnreadCounter(false);
        haptic("normal");
      }}
    >
      {contactInfos && !isLoading && (
        <View style={styles.container}>
          ...
          />
          <View
            style={{ marginLeft: 15, justifyContent: "center", height: "60%" }}
          >
            <Text
              style={{
                color: "#3a3a3a",
            ...
            >
              {contactInfos.username}
            </Text>
            <View style={{ flexDirection: "row" }}>
              {lastMessage[0].UID === userID && (
                <Text
                  style={{ color: "#4a4a4a", fontWeight: "300", fontSize: 13 }}
                >
                  Ich:{" "}
                </Text>
              )}
              <Text
                style={{
                  color: "#4a4a4a",
                  fontWeight:
                    !lastMessage[0].read && lastMessage[0].UID !== userID
                      ? "700"
                      : "300",
                  fontSize: 13,
                }}
