...
const Contacts = ({toggleView, setChat}) => {
    ...
    return(
        <View style={{flex: 1, width: Screen.width, alignItems: 'center', backgroundColor: '#eee'}}>
            <View style={{width: '90%', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginVertical: 25,}}>
            ...
            {!showSearchUsers && !showSearchFriends && (
                <View style={{width: '100%', flex:1, alignItems: 'center'}}>
                    ...
                    <TouchableOpacity 
                        onPress={() => toggleView()} 
                        style={{position: 'absolute', bottom: 75, backgroundColor: '#000', width: Screen.width / 1.3, height: 50, borderRadius: 25, alignItems: 'center', justifyContent: 'center'}}
                    >
                        <Text style={{color: '#fff', fontSize: 16, fontWeight: '600'}}>Schließen</Text>
                    </TouchableOpacity>
                </View>
            )}
            ...
            {showSearchUsers && !showSearchFriends && (
                <View style={{width: '100%', flex:1, alignItems: 'center'}}>
                    <View style={{width: Screen.width / 1.1, height: 50, backgroundColor: '#fff', borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginBottom: 25}}>
                        <TextInput 
