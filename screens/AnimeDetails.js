...
const AnimeDetails = (animeID) => {
  ...
  return (
    <View style={styles.container}>
      {data && !isLoading && (
        <View
          style={[styles.container, { backgroundColor: `${data.color}15` }]}
        >
          <View>
            <Image
          ...
          >
            ...
            <View
              style={{
                marginLeft: Screen.width / 2.5 / 1.2,
                marginTop: 10,
                flex: 1,
              }}
            >
              <Text
                style={{ color: "#3a3a3a", fontSize: 22, fontWeight: "500" }}
              >
                {data.name}
              </Text>
              <Text style={{ marginTop: 5, color: "#3a3a3a", fontSize: 12 }}>
                Genres:
              </Text>
              <View
          ...
          >
            ...
            >
              <Icon name="add-to-list" type="entypo" color={"#eee"} size={20} />
              <Text
                style={{
                  color: "#fff",
                  fontSize: 15,
            ...
            >
              <Icon name="share" type="entypo" color={data.color} size={20} />
              <Text
                style={{
                  color: data.color,
                  fontSize: 15,
          ...
          <View style={{ width: "90%", flex: 1 }}>
            <Text style={{ color: "#3a3a3a", fontSize: 13, marginBottom: 15 }}>
              {data.description}
            </Text>
            <View
              style={{
            ...
            >
              ...
              >
                <View>
                  ...
                  <Text
                    style={{ position: "absolute", color: `${data.color}90` }}
                  >
                    Seasons
                  </Text>
                </View>
