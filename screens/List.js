...
const List = () => {
  ...
  useLayoutEffect(() => {
    const q = query(
      collection(database, "users", userID, "animelist"),
    ...
    <View style={styles.container}>
      <SafeAreaView style={[styles.container, safeArea.AndroidSafeArea]}>
        ...
        >
          ...
          <Text style={{ color: "#3a3a3a", fontSize: 28, fontWeight: "600" }}>
            Deine Listen
          </Text>
          <TouchableOpacity
            onPress={() => {
              navigation.navigate("AnimeSearch");
            }}
          >
        ...
        >
          <TouchableOpacity
            ...
            style={{
              width: "49%",
              height: 52,
              backgroundColor: showWatchList ? "#fff" : "#d0d0d0",
              borderRadius: 30,
              alignItems: "center",
          ...
          >
            <Text
              style={{
                color: showWatchList ? "#d22b2b" : "#fff",
                fontSize: 16,
                fontWeight: "600",
              }}
            >
          ...
          <TouchableOpacity
            ...
            style={{
              width: "49%",
              height: 52,
              backgroundColor: showWatchList ? "#d0d0d0" : "#fff",
              borderRadius: 30,
              alignItems: "center",
              justifyContent: "center",
            }}
          >
            <Text
              style={{
                color: showWatchList ? "#fff" : "#d22b2b",
                fontSize: 16,
                fontWeight: "600",
              }}
            >
        ...
        {showWatchList && (
          <View style={{ flex: 1, justifyContent: "center", marginBottom: 50 }}>
            <Text style={{ color: "#3a3a3a", fontSize: 20, fontWeight: "300" }}>
